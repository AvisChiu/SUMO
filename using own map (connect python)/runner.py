...
def generate_routefile():
    ...
    pEW = 1. / 11
    pNS = 1. / 30
    with open("map1.rou.xml", "w") as routes:
        print("""<routes>
  ...
  <route id="route01" edges="-27592953#13 -27592953#12 "/>
  <route id="route02" edges="27592953#12 27592953#13 "/>""", file=routes)
...
if __name__ == "__main__":
    ...
    traci.start([sumoBinary, "-c", "map1.sumocfg",
